...
import { X, Camera, Copy, Check, Shield, LogOut, Trash2, Loader2, AlertCircle, Hash, Volume2, Settings2, Plus } from "lucide-react";
...
export default function ServerSettingsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex bg-black/60" onClick={onClose}>
      <div
        className="m-auto flex bg-[var(--bg-primary)] rounded-2xl w-[760px] max-h-[80vh] shadow-2xl overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Sidebar */}
        <div className="w-48 bg-[var(--bg-secondary)] flex flex-col flex-shrink-0 p-3">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-[var(--border-default)]">
            <h2 className="text-white font-bold text-lg">Paramètres du serveur</h2>
