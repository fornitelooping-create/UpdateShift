...
export default function RolesModal({ server, members, onClose, onUpdate }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60" onClick={onClose}>
      <div className="bg-[var(--bg-primary)] rounded-2xl w-[700px] max-h-[80vh] flex overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
        {/* Roles list */}
        <div className="w-56 bg-[var(--bg-secondary)] flex flex-col flex-shrink-0">
