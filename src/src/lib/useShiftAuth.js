...
export function useShiftAuthProvider() {
  ...
  // Mot de passe oublié : ne connecte pas l'utilisateur (pas de session
  // créée), il devra se reconnecter juste après avec le nouveau mot de
  // passe. Renvoie le nouveau code de récupération à afficher une fois.
